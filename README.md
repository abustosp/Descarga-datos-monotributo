# Descarga Datos del Monotributo

Bot de descarga de Distintos datos del servicio interactivo del monotributo de la AFIP. Hasta ahora posee un sub-bot para:
- Descarga de las credenciales de Pago
...
4. Descargar el BOT. Acá hay 3 opciones:
   ...
   3. Descargar el repositorio con GIT utilizando el comando `git clone https://github.com/abustosp/Descarga-datos-monotributo.git`
